        ...
        child: SingleChildScrollView(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                // 🔥 NAYA ADMIN LOGO LAGA DIYA GAYA HAI 🔥
                Container(
                  padding: const EdgeInsets.all(8), 
                  decoration: BoxDecoration(shape: BoxShape.circle, color: adminPurple.withOpacity(0.1)), 
                  child: ClipOval(
                    child: Image.network(
                      'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgweLkRYQAj7zPfj9yDYcxIx4C3u-RLWL2CMIjO7cpchRIRuo2ewM5Ns9UXzCZMP7kWzAw7vKKljsYUbRDM8dtfw0JUnuXoOBY1zv4TMuvDqoS9BperbRLBSEtvJELOnV2Q5Yyz_4cusRkbi1bZNpYC29Y0o04jYD-X2t3vs1-_FjKVdCy5QhFd_aCxNyU/s1254/file_00000000177c71f590aef0b9e92641ee.png',
                      height: 80, width: 80, fit: BoxFit.cover,
                      errorBuilder: (context, error, stackTrace) => const Icon(Icons.admin_panel_settings, size: 60, color: adminPurple),
                    ),
                  )
                ),
...
// ==========================================
// 7. APP SETTINGS (WEBSITE LINK & LOGO & SOCIALS)
// ==========================================
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text("Change user panel logo, website, and social links from here.", style: TextStyle(color: Colors.white54, fontSize: 13)), const SizedBox(height: 20),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(controller: _apkUrlController, style: const TextStyle(color: Colors.white), decoration: _inputDeco("Website/Download Link")), const SizedBox(height: 16),

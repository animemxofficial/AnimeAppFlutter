                            ...
                            children:[
                              ...
                              Positioned(
                                ...
                                child: Container(
                                  ...
                                  child: Text(i == 0 ? "Latest" : i == 1 ? "Coming Soon" : i == 2 ? "Popular" : "Recommended", style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14)),
                                ),
                              )
                            ],
                          )
      ...
      children:[
        Padding(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Row(children:[Icon(icon, color: iconColor, size: 24), const SizedBox(width: 8), Text(title, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w800, color: Colors.white))]),
              ...
              child: ClipRRect(
                ...
                child: Stack(
                  children:[
                    ...
                    Positioned(bottom: 6, right: 6, child: Container(padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2), decoration: BoxDecoration(color: Colors.black87, borderRadius: BorderRadius.circular(4)), child: const Text("24:00", style: TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.bold)))),
...
class _DetailsPageState extends State<DetailsPage> {
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Stack(
                ...
                children:[
                  ...
                  Container(decoration: BoxDecoration(gradient: LinearGradient(colors:[darkBg, Colors.transparent], begin: Alignment.bottomCenter, end: Alignment.topCenter))),
                ],
              ),
            ),
          ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children:[
                  ...
                  const SizedBox(height: 24),
                  Text("Kiyotaka Ayanokouji enters the prestigious Tokyo Metropolitan Advanced Nurturing High School...", maxLines: _isExpanded ? null : 3, overflow: _isExpanded ? null : TextOverflow.ellipsis, style: const TextStyle(color: Colors.white70, fontSize: 13, height: 1.5)),
                  const SizedBox(height: 6),
                  GestureDetector(
                  ...
                  const SizedBox(height: 12),
                  Row(children:[_buildSeasonTab(1), const SizedBox(width: 10), _buildSeasonTab(2), const SizedBox(width: 10), _buildSeasonTab(3)]),
                  const SizedBox(height: 24),
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children:[
                              ClipRRect(borderRadius: BorderRadius.circular(8), child: Image.network(widget.anime.image, width: 130, height: 80, fit: BoxFit.cover, alignment: Alignment.topCenter)),
  ...
  Widget _buildTag(IconData? icon, String text) { return Container(padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 6), decoration: BoxDecoration(color: const Color(0xFF1A1A1A), borderRadius: BorderRadius.circular(6), border: Border.all(color: Colors.white12)), child: Row(mainAxisSize: MainAxisSize.min, children:[if (icon != null) ...[Icon(icon, size: 14, color: Colors.white70), const SizedBox(width: 4)], Text(text, style: const TextStyle(color: Colors.white70, fontSize: 11, fontWeight: FontWeight.w600))])); }
  Widget _buildSeasonTab(int seasonNumber) { bool isActive = _selectedSeason == seasonNumber; return GestureDetector(onTap: () => setState(() => _selectedSeason = seasonNumber), child: Container(padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8), decoration: BoxDecoration(color: isActive ? const Color(0xFF6A5AE0) : const Color(0xFF1A1A1A), borderRadius: BorderRadius.circular(8)), child: Text("Season $seasonNumber", style: TextStyle(color: isActive ? Colors.white : Colors.white70, fontWeight: FontWeight.bold, fontSize: 13)))); }
}
...
// ==========================================
// PROFILE, PREMIUM, PAYMENT, ETC. (FULLY RESTORED)
// ==========================================

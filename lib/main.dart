...
// --- Firebase related imports (Assuming packages are installed) ---
...
final List<Anime> animeData = [
  // ... (anime data) ... (Pura code pichle versions se, no changes needed here)
  Anime(
    title: "Solo Leveling", genre: "Action", image: "https://i.ibb.co/C3rhjGv3/images-1.jpg", views: "38K", dubColor: const Color(0xFFFF4D4D), season: "S1", seasonsList: generateDummySeasons(),
  ),
  Anime(
    title: "Classroom of the Elite", genre: "Thriller", image: "https://i.ibb.co/vxJtwkcX/k.jpg", status: "Completed", views: "3K", dubColor: const Color(0xFF4DA6FF), season: "S3", seasonsList: generateClassroomOfEliteSeasons(),
  ),
  Anime(
    title: "One Piece", genre: "Adventure", image: "https://i.ibb.co/jvVk3XSY/g.jpg", views: "8.1K", dubColor: const Color(0xFF4DA6FF), season: "S1", seasonsList: generateDummySeasons(),
  ),
  Anime(
    title: "Naruto", genre: "Action", image: "https://i.ibb.co/YFg2hKvf/j.jpg", views: "4.5K", dubColor: const Color(0xFFFF9F43), season: "S1", seasonsList: generateDummySeasons(),
  ),
  Anime(
    title: "Demon Slayer", genre: "Action", image: "https://i.ibb.co/yFRNxJbG/o.jpg", views: "3.1K", dubStatus: "MIX", dubColor: const Color(0xFF00C853), season: "S2", seasonsList: generateDummySeasons(),
  ),
  Anime(
    title: "Bleach: Thousand-Year Blood War - The Conflict", genre: "Action", image: "https://i.ibb.co/DDDJNsFX/images-3.jpg", status: "Coming Soon", views: "0", dubColor: Colors.grey, season: "S3", seasonsList: [], 
  ),
];
...
List<Season> generateDummySeasons() {
  return[
    Season(name: "Season 1", episodes:[Episode(title: "The Beginning", image: "https://i.ibb.co/rW2Zk9B/images.jpg", duration: "24m 10s", views: "2.1M", videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4"), Episode(title: "A New Threat", image: "https://i.ibb.co/C3rhjGv3/images-1.jpg", duration: "23m 45s", views: "1.8M", videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4")]),
    Season(name: "Season 2", episodes:[Episode(title: "Return of Hero", image: "https://i.ibb.co/DDDJNsFX/images-3.jpg", duration: "25m 00s", views: "3.2M", videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4")]),
  ];
}

List<Season> generateClassroomOfEliteSeasons() {
  return[
    Season(name: "Season 1", episodes:[Episode(title: "Episode 1", image: "https://i.ibb.co/vxJtwkcX/k.jpg", duration: "24m 10s", views: "3.8K", videoUrl: "https://animemx-proxy.onrender.com/stream/AgADXx8AAg-FSFY"), Episode(title: "Episode 2", image: "https://i.ibb.co/vxJtwkcX/k.jpg", duration: "23m 45s", views: "1.8M", videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4")]),
    Season(name: "Season 2", episodes:[Episode(title: "Episode 1", image: "https://i.ibb.co/vxJtwkcX/k.jpg", duration: "24m 00s", views: "2.5M", videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4")]),
  ];
}

// Order data model (for Admin Panel)
class OrderItem {
...
// --- Local Storage Functions (Shared Preferences) ---
...
class AnimeMX extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const UserLoginScreen(), // Start with login screen
    );
  }
}

// ==========================================
// USER LOGIN SCREEN (GOOGLE SIGN-IN)
// ==========================================
...
class _UserLoginScreenState extends State<UserLoginScreen> {
  ...
  Future<void> _handleGoogleSignIn() async {
    ...
    // --- Replace with real Google Sign-in logic after full Firebase setup ---
    // try {
    ...
    //     // On success, navigate to MainScreen
    ...
    //   });
    // }
    // --- End of real Google Sign-in logic ---

    // --- Dummy Login Simulation (Remove once real logic added) ---
    await Future.delayed(const Duration(seconds: 2));
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const MainScreen()));
    // --- End of Dummy Login Simulation ---
  }
        ...
        child: ListView(
          ...
          children: [
                ...
                children: [
                  Container(
                    ...
                    decoration: const BoxDecoration(
                      ...
                      image: DecorationImage(image: NetworkImage("https://i.ibb.co/vxJtwkcX/k.jpg"), fit: BoxFit.cover),
                    ),
                  ),
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                // TODO: Add actual logout logic here (Firebase Auth Sign Out)
                    ...
                    children: [
                      ...
                      Container(
                        decoration: BoxDecoration(
                          gradient: LinearGradient(colors: [Colors.black.withOpacity(0.95), Colors.transparent], begin: Alignment.bottomCenter, end: Alignment.topCenter, stops: const [0.0, 0.6]),
                        ),
                      ),
                      Positioned(
                        top: 15,
              ...
              child: Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (_) => DetailsPage(anime: animeData[0])));
                    },
            ...
            children: [
              Row(
                children: [
                  ...
                  if (icon != null) ...[const SizedBox(width: 6), Icon(icon, color: iconColor, size: 20)],
                ],
              ),
              GestureDetector(
                onTap: () {
                ...
                child: const Text("See All", style: TextStyle(color: Colors.orange, fontWeight: FontWeight.bold, fontSize: 13)),
              ),
            ],
          ),
        ),
          ...
          child: Stack(
            children: [
              ...
              Positioned.fill(
                child: DecoratedBox(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(colors: [Colors.black.withOpacity(0.9), Colors.transparent], begin: Alignment.bottomCenter, end: Alignment.center),
                  ),
                ),
              ),
              Positioned(
            ...
            AspectRatio(
              ...
              child: ClipRRect(
                ...
                child: Stack(
                  fit: StackFit.expand,
                  children: [
                    Image.network(widget.item.anime.seasonsList[widget.item.seasonIndex].episodes[widget.item.episodeIndex].image, fit: BoxFit.cover),
                    ...
                    Positioned(
                      ...
                      left: 0,
                      right: 0,
                      child: LinearProgressIndicator(value: progress, backgroundColor: Colors.white24, valueColor: const AlwaysStoppedAnimation<Color>(Colors.orange), minHeight: 4),
                    ),
                  ],
                ),
              ),
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Stack(
                ...
                children: [
                  ...
                  Container(
                    decoration: BoxDecoration(
                      gradient: LinearGradient(colors: [darkBg, darkBg.withOpacity(0.5), Colors.transparent], stops: const [0.0, 0.4, 1.0], begin: Alignment.bottomCenter, end: Alignment.topCenter),
                    ),
                  ),
                ],
              ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: Text(widget.anime.rating, style: const TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.bold)),
                      ),
                      const SizedBox(width: 10),
                      const Expanded(
                        child: Text("• Dub | Action, Thriller, Drama", style: TextStyle(color: Colors.white70, fontSize: 13), overflow: TextOverflow.ellipsis),
                      ),
                    ],
                  ),
                  const SizedBox(height: 20),
                  ...
                  GestureDetector(
                    ...
                    child: Text(_isExpanded ? "Read Less" : "Read More", style: const TextStyle(color: primaryColor, fontWeight: FontWeight.bold, fontSize: 13)),
                  ),
                                ...
                                children: [
                                        ...
                                        children: [
                                          ...
                                          if (progress > 0.0)
                                            Positioned(
                                              ...
                                              left: 0,
                                              right: 0,
                                              child: LinearProgressIndicator(value: progress, backgroundColor: Colors.black54, valueColor: const AlwaysStoppedAnimation<Color>(Colors.orange), minHeight: 4),
                                            ),
                                        ],
                                      ),
                                    ),
                                  ...
                                  Expanded(
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text("${index + 1}. ${ep.title}", style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 15), maxLines: 1, overflow: TextOverflow.ellipsis),
                                        const SizedBox(height: 6),
                                        Row(
                                          children: [
  ...
  Widget _buildSeasonTab(int index, String title, Color primaryColor) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Center(
          child: Text(title, style: TextStyle(color: isActive ? Colors.white : Colors.white70, fontWeight: FontWeight.bold, fontSize: 13)),
        ),
      ),
    );
  }
        ...
        builder: (context, savedList, child) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => VideoPlayerPage(anime: item.anime, seasonIndex: item.seasonIndex, episodeIndex: item.episodeIndex)));
                },
                child: Container(
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(item.anime.title, style: const TextStyle(color: Colors.orange, fontWeight: FontWeight.bold, fontSize: 12), maxLines: 1, overflow: TextOverflow.ellipsis),
                              const SizedBox(height: 4),
                              Text(ep.title, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 15), maxLines: 1, overflow: TextOverflow.ellipsis),
                              const SizedBox(height: 6),
                              Text("${item.anime.seasonsList[item.seasonIndex].name} | Episode ${item.episodeIndex + 1}", style: const TextStyle(color: Colors.white54, fontSize: 12)),
                            ],
                          ),
                        ),
                      ),
...
class _VideoPlayerPageState extends State<VideoPlayerPage> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(ep.videoUrl), videoPlayerOptions: VideoPlayerOptions(mixWithOthers: true))
      ..initialize().then((_) {
          ...
          child: Padding(
            ...
            child: AnimatedOpacity(
              ...
              child: Container(
                ...
                child: const Column(mainAxisSize: MainAxisSize.min, children: [Icon(Icons.fast_rewind, color: Colors.white, size: 36), Text("-10s", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14))]),
              ),
            ),
          ),
        ),
          ...
          child: Padding(
            ...
            child: AnimatedOpacity(
              ...
              child: Container(
                padding: const EdgeInsets.all(20),
                decoration: const BoxDecoration(color: Colors.black54, shape: BoxShape.circle),
                child: const Column(mainAxisSize: MainAxisSize.min, children: [Icon(Icons.fast_forward, color: Colors.white, size: 36), Text("+10s", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14))]),
              ),
            ),
          ),
        ),
                                ...
                                SizedBox(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Stack(
                                      fit: StackFit.expand,
                                      children: [
                                        Image.network(widget.anime.seasonsList[widget.seasonIndex].episodes[widget.episodeIndex + 1].image, fit: BoxFit.cover),
                                        Container(color: Colors.black38),
                                        const Center(child: Icon(Icons.play_circle_fill, color: Colors.white, size: 40)),
                                      ],
                                    ),
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      children: [
                                        Text("Episode ${widget.episodeIndex + 2}", style: const TextStyle(color: Colors.orange, fontWeight: FontWeight.bold, fontSize: 13)),
                                        const SizedBox(height: 4),
                                        Text(widget.anime.seasonsList[widget.seasonIndex].episodes[widget.episodeIndex + 1].title, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16), maxLines: 1, overflow: TextOverflow.ellipsis),
                                        const SizedBox(height: 6),
                                        Row(
                                          children: [
                                            const Icon(Icons.access_time, color: Colors.white54, size: 14),
                                            const SizedBox(width: 4),
                                            Text(widget.anime.seasonsList[widget.seasonIndex].episodes[widget.episodeIndex + 1].duration, style: const TextStyle(color: Colors.white54, fontSize: 12)),
                                          ],
                                        ),
                                      ],
                                    ),
...
class _BrowseScreenState extends State<BrowseScreen> {
  ...
  void _submitSearch(String query) {
    if (query.trim().isNotEmpty && !globalRecentSearches.contains(query.trim())) {
      ...
      // saveRecentSearches(); // Save to phone storage (for persistence)
    }
    _performSearch(query);
  }
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          bottom: const TabBar(
            ...
            tabs: [Tab(text: "DUBBED"), Tab(text: "ORIGINAL")],
          ),
        ),
        body: TabBarView(
          children: [
                  ...
                  Column(
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Row(
                          children: const [Icon(Icons.add_circle_outline, color: Colors.orange, size: 14), SizedBox(width: 4), Text("Add Info", style: TextStyle(color: Colors.orange, fontWeight: FontWeight.bold, fontSize: 12))],
                        ),
                      ),
                    ],
                  ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (userActivePlan.isNotEmpty) ...[
                          ...
                          Container(
                            padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                            decoration: BoxDecoration(color: Colors.orangeAccent.withOpacity(0.2), borderRadius: BorderRadius.circular(6), border: Border.all(color: Colors.orangeAccent.withOpacity(0.6))),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Row(
                        children: [Icon(Icons.workspace_premium, color: Colors.white, size: 26), SizedBox(width: 8), Text("Go Premium", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold))],
                      ),
                      const SizedBox(height: 6),
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                Container(padding: const EdgeInsets.all(8), decoration: BoxDecoration(color: const Color(0xFF2C2C2E), borderRadius: BorderRadius.circular(8)), child: Icon(icon, color: Colors.white, size: 20)),
                const SizedBox(width: 16),
...
class PremiumPage extends StatelessWidget {
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ListView(
                ...
                padding: const EdgeInsets.symmetric(horizontal: 20),
                children: [
                  _buildNewPlanCard(context: context, title: "Lite Plan", price: "₹50", quality: "720p", ads: "NO", slot: "1", limit: "50 minutes", limitSub: "(0.8 hrs)", hasEarlyAccess: false, hasAllPremium: null, color: Colors.orange, icon: Icons.local_fire_department),
                  const SizedBox(width: 20),
                  _buildNewPlanCard(context: context, title: "Plus Plan", price: "₹100", quality: "1080p", ads: "NO", slot: "2", limit: "240 minutes", limitSub: "(4 hrs)", hasEarlyAccess: false, hasAllPremium: null, color: Colors.amber, icon: Icons.star, badgeText: "MOST POPULAR"),
                  const SizedBox(width: 20),
                  _buildNewPlanCard(context: context, title: "Pro Plan", price: "₹150", quality: "1080p", ads: "NO", slot: "3", limit: "480 minutes", limitSub: "(8 hrs)", hasEarlyAccess: true, hasAllPremium: true, color: Colors.lightBlueAccent, icon: Icons.auto_awesome),
                  const SizedBox(width: 20),
                  _buildNewPlanCard(context: context, title: "Ultra Plan", price: "₹200", quality: "1080p", ads: "NO", slot: "4", limit: "Unlimited", limitSub: null, hasEarlyAccess: true, hasAllPremium: true, earlyAccessText: "YES", allPremiumText: "YES", color: Colors.purpleAccent, icon: Icons.flash_on, isGradientBtn: true),
                ],
              ),
            ),
          ],
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [BoxShadow(color: color.withOpacity(0.15), blurRadius: 15, spreadRadius: 1)],
          ),
          ...
          child: Column(
            ...
            children: [
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Row(children: [Icon(icon, color: color, size: 24), SizedBox(width: 8), Text(title, style: TextStyle(color: color, fontSize: 22, fontWeight: FontWeight.bold))]),
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.baseline,
                    textBaseline: TextBaseline.alphabetic,
                    children: [Text(price, style: const TextStyle(color: Colors.white, fontSize: 26, fontWeight: FontWeight.bold)), const Text("/mo", style: TextStyle(color: Colors.white54, fontSize: 14))],
                  ),
                ],
              ),
              const SizedBox(height: 20),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [Text(limit, style: const TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold)), if (limitSub != null) Text(limitSub, style: const TextStyle(color: Colors.white54, fontSize: 12))],
                    ),
                  ],
                ),
              ),
              const Spacer(),
              if (!hasEarlyAccess)
                Row(children: [const Icon(Icons.check_circle_outline, color: Colors.white38, size: 18), const SizedBox(width: 8), const Text("No Early Access", style: TextStyle(color: Colors.white38, fontSize: 14))])
              else ...[
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Row(children: [const Icon(Icons.check_circle_outline, color: Colors.greenAccent, size: 18), const SizedBox(width: 8), const Text("Early Access", style: TextStyle(color: Colors.white70, fontSize: 14))]),
                    if (earlyAccessText != null) Text(earlyAccessText, style: const TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.bold)),
                  ],
                ),
                if (hasAllPremium != null) ...[
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Row(children: [const Icon(Icons.check_circle_outline, color: Colors.greenAccent, size: 18), const SizedBox(width: 8), const Text("All Premium Anime", style: TextStyle(color: Colors.white70, fontSize: 14))]),
                      if (allPremiumText != null) Text(allPremiumText, style: const TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ],
              ],
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(color: isGradientBtn ? null : color, gradient: isGradientBtn ? const LinearGradient(colors: [Colors.purpleAccent, Colors.pinkAccent]) : null, borderRadius: BorderRadius.circular(12)),
        ...
        if (badgeText != null)
          Positioned(
            ...
            child: Container(
              ...
              child: Row(
                children: [const Icon(Icons.star, color: Colors.black, size: 14), const SizedBox(width: 6), Text(badgeText, style: const TextStyle(color: Colors.black, fontSize: 12, fontWeight: FontWeight.bold))],
              ),
            ),
          ),
      ],
  ...
  Widget _buildGridRow(String feature, String value) {
    return Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [Text(feature, style: const TextStyle(color: Colors.white70, fontSize: 16)), Text(value, style: const TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold))],
      ),
    );
  }
}
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: const Row(
                children: [Icon(Icons.info_outline, color: Colors.blue), SizedBox(width: 10), Expanded(child: Text("Verify your payment to activate plan instantly.", style: TextStyle(color: Colors.blue)))],
              ),
            ),
            const SizedBox(height: 24),
            ...
            DropdownButtonFormField<String>(
              ...
              items: const [DropdownMenuItem(value: "50", child: Text("₹50 (Lite Plan)")), DropdownMenuItem(value: "100", child: Text("₹100 (Plus Plan)")), DropdownMenuItem(value: "150", child: Text("₹150 (Pro Plan)")), DropdownMenuItem(value: "200", child: Text("₹200 (Ultra Plan)"))],
              onChanged: (val) {
                setState(() {
                  _selectedAmount = val!;
                  if (val == "50") _selectedPlan = "Lite Plan";
                  if (val == "100") _selectedPlan = "Plus Plan";
                  if (val == "150") _selectedPlan = "Pro Plan";
                  if (val == "200") _selectedPlan = "Ultra Plan";
                });
              },
            ),
            const SizedBox(height: 24),
            ...
            GestureDetector(
              ...
              child: Container(
                height: 200,
                width: double.infinity,
                decoration: BoxDecoration(color: const Color(0xFF1A1A1A), borderRadius: BorderRadius.circular(16), border: Border.all(color: Colors.orange.withOpacity(0.5), style: BorderStyle.solid, width: 2)),
                child: _imageFile != null
                    ? ClipRRect(borderRadius: BorderRadius.circular(14), child: Image.file(_imageFile!, fit: BoxFit.cover))
                    : Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: const [Icon(Icons.cloud_upload_outlined, color: Colors.orange, size: 50), SizedBox(height: 10), Text("Tap to upload Screenshot", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)), Text("Supports JPG, PNG", style: TextStyle(color: Colors.white54, fontSize: 12))],
                      ),
              ),
            ),
            const SizedBox(height: 24),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Container(
              padding: const EdgeInsets.all(20),
              decoration: BoxDecoration(borderRadius: BorderRadius.circular(16), gradient: const LinearGradient(colors: [Colors.orangeAccent, Colors.deepOrange])),
              child: Row(
                children: [
                  ...
                  const Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [Text("How can we help?", style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)), Text("We're here to help you with any issues.", style: TextStyle(color: Colors.white70, fontSize: 12))],
                    ),
                  ),
                ],
              ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 15),
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text(title, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)), Text(sub, style: const TextStyle(color: Colors.white54, fontSize: 12))])),
          const Icon(Icons.arrow_forward_ios, color: Colors.white38, size: 16),
        ],
      ),
    );
          ...
          : ListView.builder(
              ...
              itemBuilder: (ctx, i) {
                ...
                return Container(
                  margin: const EdgeInsets.only(bottom: 12),
                  padding: const EdgeInsets.all(16),
                  decoration: BoxDecoration(color: const Color(0xFF1A1A1A), borderRadius: BorderRadius.circular(12), border: Border(left: BorderSide(color: order.status == "Pending" ? Colors.orange : Colors.green, width: 4))),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text(order.planName, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)), SizedBox(height: 4), Text("${order.amount} • ${order.date}", style: const TextStyle(color: Colors.white54, fontSize: 12))]),
                      Container(
                        padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),

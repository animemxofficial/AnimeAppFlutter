...
// import 'package:google_sign_in/google_sign_in.dart'; // Uncomment this after manual connection
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children:[
            ...
            // Google Form button (Replaces file upload)
            SizedBox(
              width: double.infinity,
              height: 50,
              child: ElevatedButton.icon(
                ...
                onPressed: () async {
                  // Launch Google Form in external browser or in-app webview
                  if (await canLaunchUrl(Uri.parse(googleFormLink))) {
                    await launchUrl(Uri.parse(googleFormLink), mode: LaunchMode.platformDefault);
                  } else {

...
// ==========================================
// BROWSE, DUBS, PROFILE & PAYMENT SCREENS
// ==========================================
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children:[
              ...
              const SizedBox(height: 12),
              _buildRecentItem("Naruto"), _buildRecentItem("One Piece"),
              const SizedBox(height: 24),
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        backgroundColor: const Color(0xFF0F0F0F),
        appBar: AppBar(
          backgroundColor: const Color(0xFF0F0F0F), elevation: 0, toolbarHeight: 10,
          bottom: const TabBar(indicatorColor: Color(0xFF6A5AE0), indicatorWeight: 3, labelColor: Color(0xFF6A5AE0), unselectedLabelColor: Colors.white70, tabs: [Tab(text: "ADR DUBBED"), Tab(text: "ORIGINAL")]),
        ),
        body: TabBarView(
          children:[

        ...
        child: ClipRRect(
          ...
          child: Stack(
            children:[
              ...
              Positioned(top: 10, left: 10, child: GestureDetector(onTap: () { _toggleSaveAnime(); }, child: Icon(isSaved ? Icons.bookmark : Icons.bookmark_border, color: primColor, size: 28))),
            ]
          )
        ),
      ),

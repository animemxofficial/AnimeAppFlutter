...
class _MainScreenState extends State<MainScreen> {
  ...
  void _onNavTapped(int i) {
    setState(() {
      _index = i;
      if (i == 4) {
        _profileKey = DateTime.now().toString(); // Force reload Profile screen
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    if (_isLoading) {
      return Scaffold(
        ...
        appBar: AppBar(backgroundColor: getBg(context), elevation: 0, title: const Text("Watch History", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold))),
        ...
        Padding(
          ...
          child: Row(
            ...
            children:[
              ...
              GestureDetector(onTap: () => Navigator.push(context, SmoothPageRoute(page: SeeAllCategoryPage(title: title, animeList: list))), child: Text("See All", style: TextStyle(color: primColor, fontWeight: FontWeight.bold, fontSize: 13)))
            ]
          ),
        ),
        SizedBox(
...
class ExploreScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: getBg(context),
      appBar: AppBar(title: const Text("Explore", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)), backgroundColor: getBg(context)),
      body: SafeArea(
...
class DescriptionPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.black,
      appBar: AppBar(backgroundColor: Colors.black, elevation: 0, title: const Text("About Anime", style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold))),
      body: SingleChildScrollView(
        padding: const EdgeInsets.all(20),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
        ...
        if (desc.length > 40)
          GestureDetector(
            ...
            child: const Padding(
              ...
              child: Text("See More >", style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold, fontSize: 13, letterSpacing: 0.2)),
            ),
          )
      ],
    );
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 4),
                                Text(widget.anime.title, style: const TextStyle(color: Colors.white54, fontSize: 14, fontWeight: FontWeight.w500), maxLines: 1, overflow: TextOverflow.ellipsis),
                              ],
                            )
                          ),
                    ...
                    // Single Line Description + See More
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 16),
                    ...
                    Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          // Custom Modern Rating Pill & Share
                          Row(
                            children: [
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    children: const [
                                      ...
                                      SizedBox(width: 6),
                                      Text("Share", style: TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.bold))
                                    ],
                                  ),
                                ),
                              )
                          ...
                          Row(
                            children: [
                              GestureDetector(
                                ...
                                child: Row(
                                  children: [
                                    Icon(_userLikeStatus == 1 ? Icons.thumb_up : Icons.thumb_up_alt_outlined, color: _userLikeStatus == 1 ? animeMxPurple : Colors.white70, size: 22),
                                    const SizedBox(width: 6),
                                    Text("$_likeCount", style: const TextStyle(color: Colors.white70, fontSize: 14, fontWeight: FontWeight.bold))
                                  ],
                                ),
                              ),
                              ...
                              GestureDetector(
                                ...
                                child: Row(
                                  children: [
                                    Icon(_userLikeStatus == -1 ? Icons.thumb_down : Icons.thumb_down_alt_outlined, color: _userLikeStatus == -1 ? Colors.redAccent : Colors.white70, size: 22),
                                    const SizedBox(width: 6),
                                    Text("$_dislikeCount", style: const TextStyle(color: Colors.white70, fontSize: 14, fontWeight: FontWeight.bold))
                                  ],
                                ),
                              )
                            ],
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(width: 4),
                                      Text(formattedViews, style: const TextStyle(color: Colors.white54, fontSize: 12, fontWeight: FontWeight.bold)),
                                    ],
                                  )
                                ],
                              ),

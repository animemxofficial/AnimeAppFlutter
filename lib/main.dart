...
// --- GLOBAL NOTIFIERS FOR DYNAMIC DATA ---
    ...
    try {
      final animeResponse = await Supabase.instance.client.from('anime_list').select('''
        ...
        anime_seasons (
          id, season_name,
          anime_episodes (
            id, episode_title, image_url, duration, video_url
          )
        )
      ...
      if (response != null) {
        ...
        if (response['saved_anime'] != null) {
          ...
          for (var data in savedData) {
            ...
            try {
              final animeMatch = animeListNotifier.value.firstWhere((anime) => anime.title == animeTitle);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children:[
            ...
            // DYNAMIC CATEGORY LISTS FROM DATABASE
                                ...
                                SizedBox(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Stack(
                                      fit: StackFit.expand, 
                                      children:[
                                        Image.network(currentSeason.episodes[widget.episodeIndex + 1].image, fit: BoxFit.cover, errorBuilder: (c,e,s) => const Icon(Icons.broken_image)), 
                                        Container(color: Colors.black38), 
                                        const Center(child: Icon(Icons.play_circle_fill, color: Colors.white, size: 40))
                                      ]
                                    )
      ...
      if (response != null && response['saved_anime'] != null) {
        ...
        for (var data in savedData) {
          ...
          try {
            ...
            print("Anime not found: $animeTitle");
          }
        }
        setState(() {
          myListNotifier.value = fetchedList;
